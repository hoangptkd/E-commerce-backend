...
-- Insert products
INSERT INTO `products` (`name`, `description`, `category_id`, `seller_id`, `rating`, `buyers_count`, `image_path`, `min_price`, `all_stock`, `status`) VALUES
('Samsung Galaxy S22', 'Latest model of Samsung Galaxy S series with 5G support and a great camera.', 1, 101, 4.7, 1500, 'images/samsung_galaxy_s22.jpg', 799.99, 200, 1),
('Sony 4K Smart TV', '55 inch 4K Ultra HD Smart TV with Android OS.', 2, 102, 4.5, 980, 'images/sony_4k_tv.jpg', 1200.00, 150, 1),
('Nike Running Shoes', 'Lightweight and comfortable running shoes for men.', 3, 103, 4.3, 250, 'images/nike_shoes.jpg', 89.99, 50, 1),
('Harry Potter Collection', 'All 7 books of the Harry Potter series in one collection.', 4, 104, 4.9, 3000, 'images/harry_potter_books.jpg', 120.00, 500, 1),
('Lego Building Set', 'Creative building set for kids, comes with over 100 pieces.', 5, 105, 4.6, 600, 'images/lego_building_set.jpg', 49.99, 100, 1),
('Adidas Sports Shorts', 'Breathable sports shorts for men and women.', 3, 106, 4.4, 180, 'images/adidas_shorts.jpg', 29.99, 75, 1),
('Kindle Paperwhite', 'E-reader with built-in light and waterproof design.', 4, 107, 4.8, 2500, 'images/kindle_paperwhite.jpg', 129.99, 300, 1),
('Fitbit Charge 4', 'Fitness tracker with built-in GPS and heart rate monitor.', 2, 108, 4.6, 800, 'images/fitbit_charge_4.jpg', 149.99, 120, 1),
('Nikon DSLR Camera', 'High-quality DSLR camera with 24.2 MP and 4K video recording.', 1, 109, 4.7, 150, 'images/nikon_dslr.jpg', 599.99, 50, 1),
('Puma Soccer Ball', 'Official soccer ball for training and matches.', 6, 110, 4.3, 200, 'images/puma_soccer_ball.jpg', 19.99, 300, 1),
('Blender 500W', 'Powerful blender with multiple speed settings for smoothies and soups.', 2, 111, 4.5, 700, 'images/blender_500w.jpg', 39.99, 180, 1),
('Apple MacBook Pro', 'Apple’s high-performance laptop with M1 chip and 16GB RAM.', 1, 112, 4.9, 1000, 'images/macbook_pro.jpg', 1299.99, 100, 1),
('Samsung Galaxy Buds Pro', 'Wireless earbuds with noise cancellation and long battery life.', 1, 113, 4.8, 1500, 'images/samsung_buds.jpg', 199.99, 200, 1),
('Canon EOS 90D', 'Advanced DSLR camera with a 32.5 MP sensor and 4K video recording.', 1, 114, 4.6, 300, 'images/canon_eos_90d.jpg', 1299.99, 80, 1),
('Bose SoundLink Revolve', 'Portable Bluetooth speaker with 360-degree sound.', 2, 115, 4.7, 1200, 'images/bose_soundlink.jpg', 199.99, 100, 1),
('Xiaomi Mi Band 6', 'Affordable fitness band with AMOLED display and heart rate monitoring.', 2, 116, 4.6, 500, 'images/xiaomi_mi_band.jpg', 39.99, 250, 1),
('Levi\'s 501 Jeans', 'Classic straight-fit jeans for men, comfortable and durable.', 3, 117, 4.4, 950, 'images/levis_501.jpg', 59.99, 200, 1),
...
('Apple iPhone 13', 'Latest iPhone with A15 Bionic chip, amazing camera, and 5G support.', 1, 122, 4.9, 4500, 'images/iphone_13.jpg', 799.99, 250, 1),
('Whirlpool Washing Machine', 'High-efficiency washing machine with 10kg load capacity.', 2, 123, 4.4, 600, 'images/whirlpool_washing_machine.jpg', 499.99, 150, 1),
('JBL Portable Speaker', 'Durable portable speaker with deep bass and waterproof design.', 2, 124, 4.6, 1200, 'images/jbl_speaker.jpg', 129.99, 100, 1),
('Samsungs Refrigerator', 'Smart refrigerator with AI and Wi-Fi connectivity.', 2, 125, 4.8, 400, 'images/samsung_fridge.jpg', 999.99, 60, 1),
('GoPro HERO9 Black', 'Action camera with 5K video and HyperSmooth stabilization.', 6, 126, 4.8, 700, 'images/gopro_hero9.jpg', 399.99, 120, 1);
